...
def movie_data():
    model = MLPClassifier(activation='relu', solver='lbfgs', alpha=0.05, hidden_layer_sizes=(6, 2), random_state=1)
...
def chess_game_data():
    model = MLPClassifier(activation='relu', solver='lbfgs', alpha=0.05, hidden_layer_sizes=(2, 2), random_state=1)
