...
model = KNeighborsClassifier(metric='euclidean', n_neighbors=70, weights='distance')
...
def chess_game_data():
    ...
    title = r"Learning Curves (K-nearest neighbor - Dataset 2)"
...
def movie_data():
    ...
    title = r"Learning Curves (K-nearest neighbor - Dataset 1)"
    cv = ShuffleSplit(n_splits=10, test_size=0.2, random_state=0)
    estimator = model
